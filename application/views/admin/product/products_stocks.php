...
<a class="btn btn btn-labeled btn-info" href="<?= base_url()?>admin/product_add"><i class="btn-label fa fa-plus"></i>اضافة منتج جديده</a>
...
<table class="table table-hover">
    ...
    <?php if($product->qyt > 0) : ?>
        <tr>
            ...
            <td>
                <a href="<?= base_url() ?>admin/product/<?=$product->id ?>" class="btn btn-sm btn-info">عرض</a>
